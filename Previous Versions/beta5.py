...
def format1():
    ...
    for i in range(len(htmllist)):
        try:
            ...
            if type(imgdict[skulist[i]]) == list:
                for entry in imgdict[skulist[i]]:
                    imglist.append(entry)
                    imgpos.append(imgposition)
                    imgposition+=1
            else:
                imglist.append(imgdict[skulist[i]])
                imgpos.append(imgposition)
                    ...
                    for item in g_file:
                        ...
                        for j in a:
                            ...
                            if j == 'itemprop="image"':
                                ...
                                imgdict[skulist[i]].append(a[counter+1].split('"')[1])
                                total+=1
                                print('success')
                            else:
                                counter+=1
